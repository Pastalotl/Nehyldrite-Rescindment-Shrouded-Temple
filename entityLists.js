...
charRecipes.set("Ddwgyl",{id:4,imagePath:"./Assets/Characters/Ddwgyl.png",width:64,height:64,stats:[7,8,5,8,10],sheetInfo:[{animation:"idle",frames:8}],meterMax:5,yOffset:15,
    actions: [ actionList.createAction("Thrust"), actionList.createAction("Hydrodash"), actionList.createAction("Fountain"),
        ...
        radius:10, resistances:[{type:"hydro",mult:1}], allegiance:"party"})
...
/*NPCs*/
charRecipes.set("Automata",{id:10,imagePath:"./Assets/Characters/Automata.png",width:32,height:32,stats:[8,6,7,8,4],sheetInfo:[{animation:"idle",frames:1}],meterMax:2,yOffset:6,
...
charRecipes.set("Cavro",{id:11,imagePath:"./Assets/Characters/Cavro.png",width:64,height:64,stats:[7,9,6,8,4],sheetInfo:[{animation:"idle",frames:1}],meterMax:1,yOffset:15,
...
charRecipes.set("Husk",{id:12,imagePath:"./Assets/Characters/Husk.png",width:64,height:64,stats:[11,4,11,4,4],sheetInfo:[{animation:"idle",frames:6}],meterMax:1,yOffset:15,
...
charRecipes.set("Spectre",{id:13,imagePath:"./Assets/Characters/Spectre.png",width:64,height:64,stats:[7,9,6,7,9],sheetInfo:[{animation:"idle",frames:6}],meterMax:3,yOffset:15,
    actions: [ actionList.createAction("ShadeSlash"), actionList.createAction("Cloak"), actionList.createAction("Haunt") ],
        radius:10, resistances:[{type:"lumi",mult:1.5}]  , allegiance:"cult"})

charRecipes.set("Warden",{id:14,imagePath:"./Assets/Characters/Warden.png",width:64,height:64,stats:[9,7,9,8,5],sheetInfo:[{animation:"idle",frames:1}],meterMax:2,yOffset:15,
...
charRecipes.set("Cultist",{id:15,imagePath:"./Assets/Characters/Cultist.png",width:64,height:64,stats:[5,7,6,9,9],sheetInfo:[{animation:"idle",frames:6}],meterMax:5,yOffset:15,
